/*
O setor de marketing está com algumas ideias de ações para alavancar as vendas em 2021. Uma
...
mulheres sem filhos).
Seu papel será realizar uma consulta à tabela DimCustomer e retornar as colunas:
- FirstName AS ‘Nome’
- Gender AS ‘Sexo’
